...
'tth-anamnesis': {
 ...
 title:' Keluhan Utama & Karakteristik Nyeri',
...
'tth-redflag-decision': {
 ...
 description:' Evaluasi tanda bahaya sebelum melanjutkan tatalaksana TTH',
...
'tth-frequent-treatment': {
 ...
 title:' Evaluasi Risiko Medication Overuse Headache (MOH)',
...
'tth-chronic-treatment': {
 ...
 title:' Manajemen MOH jika Ditemukan',
...
'tth-nonpharm-node': {
 ...
 title:' Latihan Postur & Posisi (PPK 2023)',
