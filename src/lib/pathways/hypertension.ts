...
'htn-initial-assessment': {
 ...
 title:' Konfirmasi TD Tinggi di Kunjungan TERPISAH',
 ...
 title:' Anamnesis Gejala Hipertensi',
...
'htn-bp-classification': {
 ...
 {
 id:'elevated-bp',
 title:' ELEVATED BP - SBP 120-129 AND DBP <80',
...
'htn-elevated-lifestyle': {
 ...
 description:' High-risk untuk HTN - Lifestyle FIRST, NO medications yet',
 items: [
 {
 ...
 title:' Weight Loss Target - Every 1kg = -1mmHg!',
...
'htn-stage1-medication-initiation': {
 ...
 title:' Side Effects Education & Warnings',
...
'htn-lifestyle-followup-decision': {
 ...
 title:' Partial Response - Intensify OR Add Meds',
...
'htn-control-status-decision': {
 ...
 title:' UNCONTROLLED despite ≥3 Drugs - Resistant HTN',
...
'htn-resistant-workup': {
 ...
 title:' Rule Out PSEUDO-Resistant HTN',
 ...
 title:'‍ Referral ke Hypertension Specialist',
...
'htn-hypertensive-crisis': {
 ...
 title:' DIFFERENTIATE: Emergency vs Urgency',
