    ...
    'svt-initial-assessment': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '🗣️ Anamnesis Kilat - Gejala Akut',
        ...
        },
        {
          ...
          title: '⚠️ HEMODYNAMIC STABILITY ASSESSMENT - CRITICAL!',
    ...
    'svt-stable-vagal-maneuvers': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '❄️ COLD WATER FACIAL IMMERSION (Diving Reflex)',
    ...
    'svt-adenosine-therapy': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '⚠️ WARN Patient Tentang Side Effects',
        ...
        },
        {
          ...
          title: '⚠️ Manage Common Side Effects',
      ...
      items: [
        {
          ...
          title: '⚠️ RE-ASSESS Hemodynamic Stability',
    ...
    'svt-elective-cardioversion': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '🍽️ NPO Status - Minimal 4-6 Jam',
        ...
        },
        {
          ...
          title: '👨‍⚕️ Cardiology Consult for Ablation Evaluation',
    ...
    'svt-post-conversion-management': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '🗣️ Assess Symptom Resolution',
        ...
        },
        {
          ...
          title: '⚠️ WPW Workup Jika Delta Wave Present',
    ...
    'svt-ablation-referral': {
      ...
      items: [
        ...
        },
        {
          ...
          title: '⚠️ Risks & Complications (RARE)',
