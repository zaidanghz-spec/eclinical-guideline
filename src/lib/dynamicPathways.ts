...
export const dynamicPathways: Record<string, DynamicPathway> = {
  ...
  'tuberkulosis-paru': {
    ...
    diseaseName: 'Tuberkulosis Paru',
    startNodeId: 'tb-initial-assessment',
    nodes: {
      'tb-initial-assessment': {
        id: 'tb-initial-assessment',
        type: 'checklist',
        title: 'Anamnesis & Pemeriksaan Awal TB',
        description: 'Sesuai PPK Indonesia - Skrining TB',
        items: [
          {
            id: 'tb-symptom-screening',
            title: 'Skrining Gejala TB',
            description: 'Batuk produktif ≥2 minggu, demam subfebris, keringat malam, penurunan BB',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Riwayat kontak TB, HIV/AIDS, DM, malnutrisi, imunosupresi',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Inspeksi dada, perkusi, auskultasi paru (ronki basah), pemeriksaan KGB',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Cari infiltrat, kavitas, fibrosis di apex paru',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'tb-diagnostic-decision': {
        id: 'tb-diagnostic-decision',
        type: 'decision',
        title: 'Pemilihan Metode Diagnostik',
        description: 'Pilih metode diagnostik berdasarkan ketersediaan fasilitas',
        warningLevel: 'info',
        branches: [
          {
            id: 'genexpert-available',
            title: 'GeneXpert MTB/RIF Tersedia',
            description: 'Gold standard WHO - deteksi MTB dan resistensi Rifampisin dalam 2 jam',
            icon: '🔬',
            color: 'blue',
            nextNodeId: 'tb-genexpert-protocol',
            riskLevel: 'low'
          },
          {
            id: 'genexpert-not-available',
            title: 'GeneXpert Tidak Tersedia',
            description: 'Gunakan BTA mikroskopis (Ziehl-Neelsen staining) 3x pemeriksaan',
            icon: '🧪',
            color: 'green',
            nextNodeId: 'tb-microscopy-protocol',
            riskLevel: 'medium'
          }
        ]
      },

      'tb-genexpert-protocol': {
        id: 'tb-genexpert-protocol',
        type: 'checklist',
        title: 'Pemeriksaan GeneXpert MTB/RIF',
        description: 'Gold standard WHO untuk diagnosis TB',
        items: [
          {
            id: 'collect-sputum-genexpert',
            title: 'Ambil Sampel Sputum',
            description: 'Sputum pagi (spot-morning-spot), minimal 1 sampel untuk GeneXpert',
            required: true,
            category: 'action'
          },
          {
            id: 'process-genexpert',
            title: 'Proses GeneXpert',
            description: 'Hasil dalam 2 jam - deteksi MTB dan resistensi Rifampisin',
            required: true,
            category: 'assessment'
          },
          {
            id: 'interpret-genexpert',
            title: 'Interpretasi Hasil',
            description: 'MTB detected/not detected + Rifampisin resistance detected/not detected',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'tb-genexpert-result': {
        id: 'tb-genexpert-result',
        type: 'decision',
        title: 'Hasil GeneXpert',
        description: 'Interpretasi hasil untuk menentukan regimen terapi',
        warningLevel: 'warning',
        branches: [
          {
            id: 'mtb-detected-rif-sensitive',
            title: 'MTB+ / Rif-Sensitive',
            description: 'TB sensitif obat - Lanjut terapi standar kategori 1',
            icon: '✅',
            color: 'green',
            nextNodeId: 'tb-drug-sensitive',
            riskLevel: 'low'
          },
          {
            id: 'mtb-detected-rif-resistant',
            title: 'MTB+ / Rif-Resistant',
            description: 'Suspek MDR-TB - Rujuk ke TB-MDR center',
            icon: '🚨',
            color: 'red',
            nextNodeId: 'tb-mdr-referral',
            riskLevel: 'high'
          },
          {
            id: 'mtb-not-detected',
            title: 'MTB Not Detected',
            description: 'Pertimbangan klinis - foto thorax suggestif? Ulangi atau kultur',
            icon: '⚠️',
            color: 'orange',
            nextNodeId: 'tb-negative-evaluation',
            riskLevel: 'medium'
          }
        ]
      },

      'tb-microscopy-protocol': {
        id: 'tb-microscopy-protocol',
        type: 'checklist',
        title: 'Pemeriksaan BTA Mikroskopis (Ziehl-Neelsen)',
        items: [
          {
            id: 'sputum-ses',
            title: 'Ambil Sputum SES (Sewaktu-Pagi-Sewaktu)',
            description: 'Minimal 3 spesimen: S (sewaktu), E (early morning), S (sewaktu hari ke-2)',
            required: true,
            category: 'action'
          },
          {
            id: 'ziehl-neelsen-staining',
            title: 'Pewarnaan Ziehl-Neelsen',
            description: 'BTA terlihat sebagai basil merah pada latar belakang biru',
            required: true,
            category: 'assessment'
          },
          {
            id: 'interpret-bta',
            title: 'Interpretasi Hasil BTA',
            description: 'Positif jika ≥2 dari 3 spesimen positif, atau 1 positif + foto thorax suggestif TB',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'tb-bta-result': {
        id: 'tb-bta-result',
        type: 'decision',
        title: 'Hasil BTA Mikroskopis',
        description: 'Klasifikasi berdasarkan hasil BTA',
        warningLevel: 'info',
        branches: [
          {
            id: 'bta-positive',
            title: 'BTA Positif',
            description: '≥2 dari 3 spesimen positif - TB Paru BTA(+)',
            icon: '✅',
            color: 'green',
            nextNodeId: 'tb-drug-sensitive',
            riskLevel: 'medium'
          ...
          {
            id: 'bta-negative-xray-positive',
            title: 'BTA(-) Foto Thorax Suggestif',
            description: 'TB Paru BTA(-) Ro(+) - Mulai OAT empiris',
            icon: '📸',
            color: 'yellow',
            nextNodeId: 'tb-drug-sensitive',
            riskLevel: 'medium'
          ...
          {
            id: 'bta-negative-xray-negative',
            title: 'BTA(-) Foto Thorax Normal',
            description: 'Evaluasi diagnosis banding, pertimbangan kultur',
            icon: '❌',
            color: 'orange',
            nextNodeId: 'tb-negative-evaluation',
            riskLevel: 'low'
      ...
      'tb-drug-sensitive': {
        ...
        type: 'checklist',
        title: 'Terapi TB Sensitif Obat - Kategori 1',
        description: 'Regimen 2RHZE / 4RH sesuai PPK Indonesia',
        items: [
          {
            id: 'check-contraindications',
            title: 'Check Kontraindikasi OAT',
            description: 'Riwayat hepatitis, gangguan fungsi hati/ginjal, neuropati, riwayat alergi',
            required: true,
            category: 'safety'
          },
          {
            id: 'calculate-dose',
            title: 'Hitung Dosis Berdasarkan Berat Badan',
            description: 'Gunakan FDC (Fixed-Dose Combination) sesuai BB: <38kg, 38-54kg, 55-70kg, >70kg',
            required: true,
            category: 'medication'
          },
          {
            id: 'intensive-phase',
            title: 'Fase Intensif (2 Bulan): RHZE',
            description: 'Rifampisin + Isoniazid + Pirazinamid + Etambutol - setiap hari, diminum pagi sebelum makan',
            required: true,
            category: 'medication'
          },
          {
            id: 'give-vitamin-b6',
            title: 'Berikan Vitamin B6 (Piridoksin) 10mg/hari',
            description: 'Mencegah neuropati perifer akibat Isoniazid',
            required: true,
            category: 'medication'
          },
          {
            ...
            description: 'Pentingnya adherence, efek samping OAT (urin merah, hepatitis), pentingnya DOT',
            required: true,
            category: 'documentation'
          },
          {
            id: 'register-tb',
            title: 'Daftarkan di TB Register',
            description: 'Input ke SITB (Sistem Informasi TB) dan TB01',
            required: true,
            category: 'documentation'
          },
          {
            id: 'arrange-dot',
            title: 'Atur DOT (Directly Observed Treatment)',
            description: 'Tentukan PMO (Pengawas Menelan Obat) - keluarga atau kader',
            required: true,
            category: 'action'
          }
        ]
      ...
      'tb-continuation-phase': {
        ...
        type: 'checklist',
        title: 'Fase Lanjutan (4 Bulan): RH',
        description: 'Setelah 2 bulan fase intensif',
        items: [
          {
            id: 'evaluate-after-intensive',
            title: 'Evaluasi Akhir Fase Intensif',
            description: 'BTA ulang bulan ke-2, evaluasi klinis, check hepatotoksisitas',
            required: true,
            category: 'assessment'
          },
          {
            id: 'continuation-rh',
            title: 'Berikan RH (Rifampisin + Isoniazid)',
            description: '4 bulan, setiap hari atau 3x seminggu (DOT)',
            required: true,
            category: 'medication'
          },
          {
            ...
            description: 'BB, keluhan, adherence, efek samping, BTA bulan ke-5 (akhir pengobatan)',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'tb-mdr-referral': {
        id: 'tb-mdr-referral',
        type: 'checklist',
        title: 'Rujukan TB-MDR',
        description: 'Resistensi Rifampisin terdeteksi',
        items: [
          {
            id: 'isolate-patient',
            title: 'Isolasi Pasien',
            description: 'Ruang isolasi dengan ventilasi adekuat, masker N95 untuk petugas',
            required: true,
            category: 'safety'
          },
          {
            id: 'contact-mdr-center',
            title: 'Hubungi RS Rujukan TB-MDR',
            description: 'RS dengan fasilitas pengobatan TB-MDR/RR',
            required: true,
            category: 'action'
          },
          {
            id: 'prepare-documents',
            title: 'Siapkan Dokumen Rujukan',
            description: 'Hasil GeneXpert, foto thorax, riwayat pengobatan TB sebelumnya',
            required: true,
            category: 'documentation'
          },
          {
            id: 'dont-start-category1',
            title: 'JANGAN Mulai OAT Kategori 1',
            description: 'Tunggu regimen lini ke-2 dari RS rujukan MDR',
            required: true,
            category: 'safety'
          }
        ]
      ...
      'tb-negative-evaluation': {
        id: 'tb-negative-evaluation',
        type: 'checklist',
        title: 'Evaluasi TB Negatif',
        items: [
          {
            id: 'review-clinical',
            title: 'Review Klinis & Radiologis',
            description: 'Apakah gejala dan foto thorax sangat suggestif TB?',
            required: true,
            category: 'assessment'
          },
          {
            id: 'consider-culture',
            title: 'Pertimbangkan Kultur MTB',
            description: 'Jika fasilitas tersedia dan kecurigaan klinis tinggi',
            required: false,
            category: 'assessment'
          },
          {
            id: 'differential-diagnosis',
            title: 'Pikirkan Diagnosis Banding',
            description: 'Pneumonia bakterial, bronkiektasis, keganasan paru, TB ekstrapulmonal',
            required: true,
            category: 'assessment'
          },
          {
            id: 'empirical-oat',
            title: 'Jika Sangat Suggestif: Mulai OAT Empiris',
            description: 'Dengan persetujuan konsultan, evaluasi ketat respon terapi',
            required: false,
            category: 'action'
          }
        ]
  ...
  // ACUTE CORONARY SYNDROME (ACS) - PERKI 2018 + ESC 2020 - EXPANDED VERSION
  'acs': {
    diseaseId: 'acs',
    diseaseName: 'Acute Coronary Syndrome (Sindrom Koroner Akut)',
    startNodeId: 'acs-initial',
    nodes: {
      'acs-initial': {
        id: 'acs-initial',
        type: 'checklist',
        title: 'Initial Assessment ACS - Dalam 10 Menit Pertama',
        description: 'ABCDE + 12-lead ECG <10 menit + Initial medications',
        items: [
          {
            id: 'acs-time-arrival',
            title: 'Catat Waktu Kedatangan & Onset Nyeri',
            description: 'Door time + onset nyeri dada (untuk hitung door-to-balloon/needle time)',
            required: true,
            category: 'documentation'
          },
          {
            ...
            description: 'Pastikan jalan napas paten, tidak ada obstruksi',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-breathing',
            title: 'Breathing: RR, SpO2, Auskultasi Paru',
            description: 'Check respiratory rate (12-20x/menit), SpO2 (target >94%), ronki (tanda edema paru)',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-circulation',
            title: 'Circulation: HR, BP, Perfusi',
            description: 'Heart rate, Blood pressure (kedua lengan), CRT, akral, nadi perifer',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-disability',
            title: 'Disability: GCS, Kesadaran',
            description: 'Glasgow Coma Scale 15 (composmentis), tanda syok/hipoperfusi serebral',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-chest-pain-opqrst',
            title: 'OPQRST Nyeri Dada',
            description: 'Onset (kapan mulai), Provocation (aktivitas/istirahat), Quality (crushing/pressure/terbakar), Radiation (lengan kiri/rahang/punggung), Severity (0-10), Time (durasi)',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'DM, hipertensi, dislipidemia, merokok, riwayat keluarga CAD, obesitas',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-o2-if-needed',
            title: 'Oksigen Jika SpO2 <94%',
            description: 'Nasal kanul 2-4 L/menit, target SpO2 94-98%. JANGAN berikan O2 rutin jika saturasi normal (ESC 2020)',
            required: true,
            category: 'medication'
          },
          {
            id: 'acs-iv-access',
            title: 'Pasang IV Line (18G atau Lebih Besar)',
            description: 'Minimal 1 jalur IV perifer dengan abocath besar (18G) untuk akses obat dan cairan',
            required: true,
            category: 'action'
          },
          {
            id: 'acs-cardiac-monitor',
            title: 'Pasang Cardiac Monitor',
            description: 'Monitoring kontinyu EKG, deteksi aritmia (VT, VF, bradiaritmia)',
            required: true,
            category: 'action'
          },
          {
            id: 'acs-ecg-10min',
            title: 'EKG 12-Lead dalam 10 Menit (KRUSIAL!)',
            description: 'Tentukan STEMI vs NSTEMI/UA. Ulangi tiap 15-30 menit jika nyeri persisten',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-cardiac-markers',
            title: 'Ambil Darah: Troponin, CK-MB, Darah Lengkap, Elektrolit, Fungsi Ginjal, Lipid, Gula Darah',
            description: 'Troponin I/T (gold standard cardiac biomarker), JANGAN tunggu hasil untuk terapi awal!',
            required: true,
            category: 'assessment'
          },
          {
            id: 'acs-chest-xray',
            title: 'Foto Thorax AP/PA (Jika Memungkinkan)',
            description: 'Evaluasi kardiomegali, edema paru, diagnosis banding (pneumothorax, diseksi aorta)',
            required: false,
            category: 'assessment'
          }
        ]
      ...
      'acs-ecg-interpretation': {
        ...
        type: 'decision',
        title: 'Interpretasi EKG 12-Lead',
        description: 'Klasifikasi ACS berdasarkan EKG → Menentukan strategi reperfusi',
        warningLevel: 'critical',
        branches: [
          {
            id: 'stemi',
            title: 'STEMI (ST-Elevation MI)',
            description: 'ST elevasi ≥1mm (0.1mV) di ≥2 lead bersebelahan, LBBB baru, ST depresi V1-V3 (posterior MI), Sgarbossa criteria',
            icon: '🚨',
            color: 'red',
            nextNodeId: 'stemi-immediate-treatment',
            riskLevel: 'high'
          },
          {
            id: 'nstemi-ua',
            title: 'NSTEMI / Unstable Angina',
            description: 'ST depresi, T inversi, gelombang Q patologis, ATAU EKG normal tapi troponin positif/nyeri angina tipikal',
            icon: '⚠️',
            color: 'orange',
            nextNodeId: 'nstemi-immediate-treatment',
            riskLevel: 'medium'
          }
        ]
      },

      // STEMI PATHWAY dengan BANYAK checklist

      'stemi-immediate-treatment': {
        id: 'stemi-immediate-treatment',
        type: 'checklist',
        title: 'STEMI: Immediate Treatment - TIME IS MUSCLE!',
        description: 'Target: Door-to-Balloon <90 min atau Door-to-Needle <30 min',
        items: [
          {
            id: 'stemi-aspirin-load',
            title: 'Aspirin 160-320mg (KUNYAH) - STAT',
            description: 'Loading dose Aspirin, KUNYAH untuk absorpsi cepat, kecuali alergi atau perdarahan aktif GI',
            required: true,
            category: 'medication'
          },
          {
            id: 'stemi-p2y12-inhibitor',
            title: 'P2Y12 Inhibitor: Clopidogrel 600mg ATAU Ticagrelor 180mg',
            description: 'Dual antiplatelet therapy. Ticagrelor lebih kuat (PLATO trial) tapi lebih mahal. Clopidogrel 600mg loading jika akan fibrinolisis',
            required: true,
            category: 'medication'
          },
          {
            id: 'stemi-anticoagulation',
            title: 'Antikoagulan: UFH atau LMWH',
            description: 'UFH 60 IU/kg bolus IV (max 4000 IU) + infus 12 IU/kg/jam ATAU Enoxaparin 30mg IV bolus + 1mg/kg SC q12h',
            required: true,
            category: 'medication'
          },
          {
            id: 'stemi-morphine-if-needed',
            title: 'Morphine Sulfate 2-4mg IV (Jika Nyeri Berat)',
            description: 'PRN untuk nyeri tidak hilang dengan nitrat. Hati-hati efek depresi napas & hipotensi',
            required: false,
            category: 'medication'
          },
          {
            id: 'stemi-nitrate-sl',
            title: 'Nitrogliserin SL 0.4mg (Jika SBP >90 mmHg)',
            description: 'Sublingual tiap 5 menit max 3 dosis. KONTRAINDIKASI: SBP <90, RV infarct, PDE-5 inhibitor <24h',
            required: false,
            category: 'medication'
          },
          {
            id: 'stemi-beta-blocker-oral',
            title: 'Beta-Blocker Oral (Jika Tidak Ada Kontraindikasi)',
            description: 'Bisoprolol 2.5-5mg atau Metoprolol 25-50mg PO. HINDARI jika: bradikardi <60, SBP <100, tanda gagal jantung akut, AV block',
            required: false,
            category: 'medication'
          },
          {
            id: 'stemi-statin-high-dose',
            title: 'Statin Dosis Tinggi - Atorvastatin 40-80mg',
            description: 'STAT dose untuk stabilisasi plak. Target LDL <70 mg/dL',
            required: true,
            category: 'medication'
          },
          {
            id: 'stemi-acei-if-stable',
            title: 'ACE Inhibitor (Jika Hemodinamik Stabil)',
            description: 'Captopril 6.25mg test dose ATAU Ramipril 2.5mg. Hindari jika SBP <100 atau syok',
            required: false,
            category: 'medication'
          },
          {
            id: 'stemi-activate-cath-lab',
            title: 'Aktivasi Cath Lab / Konsul Kardiologi STAT',
            description: 'Hubungi interventional cardiologist segera untuk primary PCI',
            required: true,
            category: 'action'
          },
          {
            id: 'stemi-informed-consent',
            title: 'Informed Consent untuk Reperfusion Therapy',
            description: 'Jelaskan risiko PCI/fibrinolisis: perdarahan, stroke, re-infarction, kematian (<1% untuk PCI)',
            required: true,
            category: 'documentation'
          }
        ]
      ...
      'stemi-reperfusion-decision': {
        id: 'stemi-reperfusion-decision',
        type: 'decision',
        title: 'Strategi Reperfusi STEMI',
        description: 'Pilih berdasarkan waktu onset, ketersediaan fasilitas, dan kontraindikasi',
        warningLevel: 'critical',
        branches: [
          {
            id: 'primary-pci',
            title: 'Primary PCI (PILIHAN TERBAIK)',
            description: 'Cath lab tersedia, door-to-balloon <90 min (atau <120 min jika transfer), <12 jam onset',
            icon: '🏥',
            color: 'blue',
            nextNodeId: 'pci-preparation',
            riskLevel: 'low'
          },
          {
            id: 'fibrinolysis',
            title: 'Fibrinolisis (Thrombolytic Therapy)',
            description: 'PCI tidak tersedia/delay >120 min, <12 jam onset (ideal <3 jam), TIDAK ADA kontraindikasi',
            icon: '💉',
            color: 'orange',
            nextNodeId: 'fibrinolysis-protocol',
            riskLevel: 'medium'
          },
          {
            id: 'transfer-pci-center',
            title: 'Transfer ke PCI Center',
            description: 'Tidak ada cath lab di RS, transfer time <120 min, ambulans dengan ACLS ready',
            icon: '🚑',
            color: 'purple',
            nextNodeId: 'transfer-protocol',
            riskLevel: 'medium'
          }
        ]
      },
      ...
      'pci-preparation': {
        id: 'pci-preparation',
        type: 'checklist',
        title: 'Persiapan Primary PCI',
        description: 'Pre-procedural checklist',
        items: [
          {
            id: 'pci-activate-team',
            title: 'Aktivasi Tim Cath Lab',
            description: 'Interventional cardiologist, cath lab nurse, radiographer, anesthesiologist (jika perlu)',
            required: true,
            category: 'action'
          },
          {
            id: 'pci-access-site',
            title: 'Tentukan Akses: Radial vs Femoral',
            description: 'Radial preferred (MATRIX trial: ↓ bleeding, ↓ mortality). Femoral jika anatomis sulit atau syok kardiogenik',
            required: true,
            category: 'action'
          },
          {
            id: 'pci-shave-prep',
            title: 'Persiapan Area Akses',
            description: 'Shave & disinfeksi area radial/femoral dengan chlorhexidine',
            required: true,
            category: 'action'
          },
          {
            id: 'pci-additional-antiplatelet',
            title: 'Consider GP IIb/IIIa Inhibitor (Jika Large Thrombus Burden)',
            description: 'Tirofiban atau Eptifibatide jika TIMI flow <3 atau large clot',
            required: false,
            category: 'medication'
          },
          {
            id: 'pci-renal-protection',
            title: 'Proteksi Fungsi Ginjal',
            description: 'Hidrasi NaCl 0.9% 1 mL/kg/jam, N-acetylcysteine 600mg bid (kontroversial), hindari contrast overload',
            required: true,
            category: 'medication'
          },
          {
            id: 'pci-perform-procedure',
            title: 'Lakukan Coronary Angiography + PCI',
            description: 'Identifikasi culprit lesion, wire crossing, balloon angioplasty, stent implantation (DES preferred)',
            required: true,
            category: 'action'
          },
          {
            id: 'pci-post-procedure-check',
            title: 'Post-PCI Assessment',
            description: 'TIMI flow grade, hemostasis di access site, EKG post-PCI (ST resolution?), komplikasi (diseksi, perforasi, no-reflow)',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'fibrinolysis-protocol': {
        id: 'fibrinolysis-protocol',
        type: 'checklist',
        title: 'Protokol Fibrinolisis (Thrombolytic Therapy)',
        description: 'Door-to-needle time <30 menit',
        items: [
          {
            id: 'fibrinolysis-absolute-contraindications',
            title: 'Check Kontraindikasi ABSOLUT',
            description: 'Stroke hemoragik (KAPAN PUN), stroke iskemik <3 bulan, tumor SSP, trauma kepala berat <3 bulan, perdarahan aktif, suspected aortic dissection',
            required: true,
            category: 'safety'
          },
          {
            id: 'fibrinolysis-relative-contraindications',
            title: 'Check Kontraindikasi RELATIF',
            description: 'TIA <6 bulan, antikoagulan oral, hamil, trauma/CPR >10 menit, operasi mayor <3 minggu, puncture non-compressible, GI bleeding <1 bulan, refractory hypertension (SBP >180)',
            required: true,
            category: 'safety'
          },
          {
            id: 'fibrinolysis-choose-agent',
            title: 'Pilih Agen Fibrinolitik',
            description: 'Streptokinase 1.5 juta IU IV dalam 60 menit (non-fibrin-specific, murah) ATAU Tenecteplase/TNK (weight-based single bolus, fibrin-specific, lebih mahal)',
            required: true,
            category: 'medication'
          },
          {
            id: 'fibrinolysis-streptokinase-protocol',
            title: 'Jika Streptokinase: 1.5 Juta IU dalam 100 mL NaCl 0.9% Drip 60 Menit',
            description: 'Monitor BP tiap 15 menit (risiko hipotensi), siapkan adrenalin & steroid jika reaksi alergi',
            required: false,
            category: 'medication'
          },
          {
            id: 'fibrinolysis-tnk-protocol',
            title: 'Jika TNK: Weight-Based Single Bolus IV',
            description: '<60kg=30mg, 60-69kg=35mg, 70-79kg=40mg, 80-89kg=45mg, ≥90kg=50mg. Push IV dalam 5-10 detik',
            required: false,
            category: 'medication'
          },
          {
            id: 'fibrinolysis-adjunctive-anticoagulation',
            title: 'Antikoagulan Adjunctive',
            description: 'UFH bolus 60 IU/kg (max 4000) + infus 12 IU/kg/jam (target aPTT 1.5-2x control) ATAU Enoxaparin 30mg IV + 1mg/kg SC q12h',
            required: true,
            category: 'medication'
          },
          {
            id: 'fibrinolysis-monitor-reperfusion',
            title: 'Monitor Tanda Reperfusi (15-60 Menit Post-Lytic)',
            description: 'ST elevasi turun >50%, nyeri dada menghilang, aritmia reperfusi (accelerated idioventricular rhythm, VT/VF), peak CK-MB awal',
            required: true,
            category: 'assessment'
          },
          {
            id: 'fibrinolysis-monitor-bleeding',
            title: 'Monitor Komplikasi Perdarahan',
            description: 'ICH (sakit kepala, muntah, penurunan kesadaran), GI bleeding, hematuria, puncture site bleeding. Stop jika perdarahan mayor',
            required: true,
            category: 'safety'
          },
          {
            id: 'fibrinolysis-ecg-90min',
            title: 'EKG Ulang 90 Menit Post-Fibrinolisis',
            description: 'Evaluasi ST resolution. Jika ST tetap elevasi >50% = FAILED LYSIS → Rescue PCI',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'fibrinolysis-success-decision': {
        id: 'fibrinolysis-success-decision',
        type: 'decision',
        title: 'Evaluasi Keberhasilan Fibrinolisis',
        description: 'Berdasarkan clinical response dan EKG 90 menit',
        warningLevel: 'warning',
        branches: [
          {
            id: 'fibrinolysis-success',
            title: 'Fibrinolisis BERHASIL',
            description: 'ST turun >50%, nyeri hilang, reperfusion arrhythmia, hemodinamik stabil',
            icon: '✅',
            color: 'green',
            nextNodeId: 'post-fibrinolysis-success',
            riskLevel: 'low'
          },
          {
            id: 'fibrinolysis-failed',
            title: 'Fibrinolisis GAGAL (Failed Lysis)',
            description: 'ST tetap elevasi >50%, nyeri persisten, hemodinamik tidak stabil',
            icon: '🚨',
            color: 'red',
            nextNodeId: 'rescue-pci',
            riskLevel: 'high'
          }
        ]
      },

      'post-fibrinolysis-success': {
        id: 'post-fibrinolysis-success',
        type: 'checklist',
        title: 'Post-Fibrinolisis (Successful Reperfusion)',
        items: [
          {
            id: 'post-lysis-continue-antiplatelet',
            title: 'Lanjutkan Dual Antiplatelet Therapy',
            description: 'Aspirin 75-100mg OD + Clopidogrel 75mg OD untuk minimal 12 bulan',
            required: true,
            category: 'medication'
          },
          {
            id: 'post-lysis-angiography-plan',
            title: 'Rencanakan Angiografi dalam 3-24 Jam',
            description: 'Pharmacoinvasive strategy: angiografi + PCI jika perlu untuk residual stenosis',
            required: true,
            category: 'action'
          },
          {
            id: 'post-lysis-monitoring',
            title: 'Monitoring di ICCU/CCU',
            description: 'Cardiac monitoring, observasi aritmia, reinfarction, mechanical complications',
            required: true,
            category: 'action'
          }
        ]
      ...
      'rescue-pci': {
        id: 'rescue-pci',
        type: 'checklist',
        title: 'Rescue PCI (Failed Fibrinolysis)',
        description: 'Emergency PCI after failed lysis',
        items: [
          {
            id: 'rescue-activate-cath',
            title: 'Aktivasi Cath Lab STAT',
            description: 'Emergency rescue PCI untuk failed fibrinolysis',
            required: true,
            category: 'action'
          },
          {
            id: 'rescue-transfer-if-needed',
            title: 'Transfer ke PCI Center (Jika Tidak Ada Fasilitas)',
            description: 'Ambulans dengan ACLS, lanjutkan antikoagulan dan antiplatelet',
            required: false,
            category: 'action'
          },
          {
            id: 'rescue-high-bleeding-risk',
            title: 'Waspadai Risiko Perdarahan Lebih Tinggi',
            description: 'Post-lytic state meningkatkan risiko bleeding saat PCI',
            required: true,
            category: 'safety'
          }
        ]
      ...
      'transfer-protocol': {
        ...
        items: [
          {
            id: 'transfer-contact-receiving',
            title: 'Hubungi RS Rujukan - Konfirmasi Cath Lab Ready',
            description: 'Pre-notify receiving hospital, confirm cath lab availability',
            required: true,
            category: 'action'
          },
          {
            id: 'transfer-continue-meds',
            title: 'Lanjutkan Dual Antiplatelet + Antikoagulan Selama Transfer',
            description: 'Aspirin, P2Y12 inhibitor, heparin infusion',
            required: true,
            category: 'medication'
          },
          {
            id: 'transfer-acls-capable-ambulance',
            title: 'Ambulans dengan Kemampuan ACLS',
            description: 'Paramedic terlatih, defibrillator, obat-obat resusitasi',
            required: true,
            category: 'action'
          },
          {
            id: 'transfer-monitoring-enroute',
            title: 'Monitoring Kontinyu Selama Transfer',
            description: 'Cardiac monitor, pulse oximetry, BP, siap atasi aritmia/komplikasi',
            required: true,
            category: 'action'
          }
        ]
      ...
      'nstemi-immediate-treatment': {
        id: 'nstemi-immediate-treatment',
        type: 'checklist',
        title: 'NSTEMI/UA: Initial Management',
        description: 'Anti-ischemic & antithrombotic therapy + risk stratification',
        items: [
          {
            id: 'nstemi-aspirin',
            title: 'Aspirin 160-320mg Loading Dose (Kunyah)',
            description: 'STAT, kecuali alergi atau perdarahan aktif',
            required: true,
            category: 'medication'
          },
          {
            id: 'nstemi-p2y12',
            title: 'P2Y12 Inhibitor: Ticagrelor 180mg ATAU Clopidogrel 300mg',
            description: 'Ticagrelor preferred (PLATO trial) untuk NSTEMI moderate-high risk',
            required: true,
            category: 'medication'
          },
          {
            id: 'nstemi-anticoagulation',
            title: 'Antikoagulan: Fondaparinux 2.5mg SC OD (Pilihan) ATAU Enoxaparin 1mg/kg SC q12h',
            description: 'Fondaparinux lowest bleeding risk (OASIS-5 trial). Hindari UFH kecuali akan angiografi <24h',
            required: true,
            category: 'medication'
          },
          {
            id: 'nstemi-beta-blocker',
            title: 'Beta-Blocker: Bisoprolol 2.5-5mg atau Metoprolol 25-50mg',
            description: 'Kecuali kontraindikasi: bradikardi, hipotension, tanda gagal jantung, COPD berat',
            required: false,
            category: 'medication'
          },
          {
            id: 'nstemi-nitrate-sl-iv',
            title: 'Nitrat: Sublingual ATAU IV Infusion (Jika Nyeri Persisten)',
            description: 'NTG SL 0.4mg q5min PRN ATAU IV infusion 10-200 mcg/min. Hindari jika SBP <90, RV infarct',
            required: false,
            category: 'medication'
          },
          {
            id: 'nstemi-morphine-prn',
            title: 'Morphine 2-4mg IV (Jika Nyeri Tidak Teratasi Nitrat)',
            description: 'PRN untuk nyeri berat, hati-hati depresi napas',
            required: false,
            category: 'medication'
          },
          {
            id: 'nstemi-statin',
            title: 'Statin High-Intensity: Atorvastatin 40-80mg',
            description: 'STAT dose untuk plak stabilization',
            required: true,
            category: 'medication'
          },
          {
            id: 'nstemi-acei',
            title: 'ACE Inhibitor (Jika Hemodinamik Stabil)',
            description: 'Captopril 6.25mg test dose atau Ramipril 2.5mg, terutama jika ada tanda LV dysfunction',
            required: false,
            category: 'medication'
          },
          {
            id: 'nstemi-check-troponin',
            title: 'Check Troponin I/T (Baseline dan Serial)',
            description: 'Baseline + ulang 3-6 jam. Troponin naik = NSTEMI. Troponin normal + EKG normal = Unstable Angina',
            required: true,
            category: 'assessment'
          },
          {
            id: 'nstemi-echo',
            title: 'Echocardiography (Jika Memungkinkan)',
            description: 'Evaluasi LV function (EF), wall motion abnormality, komplikasi mekanik, diagnosis banding',
            required: false,
            category: 'assessment'
          }
        ]
      ...
      'nstemi-grace-score': {
        id: 'nstemi-grace-score',
        type: 'checklist',
        title: 'Hitung GRACE Risk Score',
        description: 'Risk stratification untuk timing angiografi',
        items: [
          {
            id: 'grace-age',
            title: 'Age (Umur Pasien)',
            description: 'Variable GRACE: Age in years',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-hr',
            title: 'Heart Rate (Denyut Jantung)',
            description: 'Variable GRACE: Heart rate (beats/min)',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Variable GRACE: SBP (mmHg)',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Variable GRACE: Creatinine level (mg/dL atau μmol/L)',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-killip-class',
            title: 'Killip Class (Tanda Gagal Jantung)',
            description: 'I=no CHF, II=rales/S3, III=pulmonary edema, IV=cardiogenic shock',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-cardiac-arrest',
            title: 'Cardiac Arrest at Admission?',
            description: 'Variable GRACE: Apakah ada cardiac arrest saat tiba?',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-st-deviation',
            title: 'ST Segment Deviation di EKG?',
            description: 'Variable GRACE: ST depression atau transient ST elevation',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-elevated-cardiac-enzymes',
            title: 'Elevated Cardiac Enzymes (Troponin)?',
            description: 'Variable GRACE: Troponin positif?',
            required: true,
            category: 'assessment'
          },
          {
            id: 'grace-calculate-total',
            title: 'Hitung Total GRACE Score',
            description: 'Use online calculator or table. Score range 1-372. <109=Low, 109-140=Intermediate, >140=High risk',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'nstemi-risk-stratification': {
        ...
        type: 'decision',
        title: 'Risk Stratification NSTEMI (GRACE Score)',
        description: 'Menentukan timing invasive strategy',
        warningLevel: 'warning',
        branches: [
          {
            id: 'grace-very-high-risk',
            title: 'Very High Risk (GRACE >140) ATAU Unstable',
            description: 'Angiografi EMERGENCY (<2 jam): hemodinamik unstable, angina refractory, aritmia life-threatening, mechanical complications, recurrent ST changes',
            icon: '🚨',
            color: 'red',
            nextNodeId: 'nstemi-immediate-angiography',
            riskLevel: 'high'
          },
          {
            id: 'grace-high-risk',
            title: 'High Risk (GRACE 109-140)',
            description: 'Early invasive strategy: Angiografi dalam 24 jam',
            icon: '⚡',
            color: 'orange',
            nextNodeId: 'nstemi-early-invasive',
            riskLevel: 'medium'
          },
          {
            id: 'grace-low-risk',
            title: 'Low Risk (GRACE <109)',
            description: 'Selective invasive strategy: Angiografi dalam 72 jam ATAU stress test dulu',
            icon: '✅',
            color: 'green',
            nextNodeId: 'nstemi-conservative',
            riskLevel: 'low'
          }
        ]
      },

      'nstemi-immediate-angiography': {
        id: 'nstemi-immediate-angiography',
        type: 'checklist',
        title: 'NSTEMI Very High Risk - Immediate Angiography (<2 Jam)',
        items: [
          {
            id: 'immediate-angio-activate',
            title: 'Aktivasi Cath Lab STAT',
            description: 'Emergency coronary angiography untuk very high risk NSTEMI',
            required: true,
            category: 'action'
          },
          {
            id: 'immediate-angio-stabilize',
            title: 'Stabilisasi Hemodinamik',
            description: 'IV fluids jika hipotensi, inotropes/vasopressors jika syok, IABP jika cardiogenic shock',
            required: true,
            category: 'action'
          },
          {
            id: 'immediate-angio-continue-anticoagulation',
            title: 'Lanjutkan Antikoagulan',
            description: 'Switch ke UFH untuk angiografi: bolus 70-100 IU/kg, target ACT 250-350',
            required: true,
            category: 'medication'
          },
          {
            id: 'immediate-angio-procedure',
            title: 'Coronary Angiography + Ad-Hoc PCI',
            description: 'Identifikasi culprit lesion, PCI jika anatomis suitable, CABG jika left main/3-vessel disease severe',
            required: true,
            category: 'action'
          }
        ]
      ...
      'nstemi-early-invasive': {
        ...
        type: 'checklist',
        title: 'NSTEMI High Risk - Early Invasive (<24 Jam)',
        items: [
          {
            id: 'early-invasive-schedule',
            title: 'Schedule Angiografi dalam 24 Jam',
            description: 'Koordinasi dengan tim kateterisasi jantung',
            required: true,
            category: 'action'
          },
          {
            id: 'early-invasive-optimize-medical',
            title: 'Optimalisasi Terapi Medis',
            description: 'Dual antiplatelet, antikoagulan, beta-blocker, statin, ACE-I, kontrol nyeri',
            required: true,
            category: 'medication'
          },
          {
            id: 'early-invasive-monitoring',
            title: 'Monitoring Ketat di ICCU/CCU',
            description: 'Cardiac monitoring, observasi nyeri berulang, perubahan EKG, aritmia',
            required: true,
            category: 'action'
          },
          {
            id: 'early-invasive-pre-cath-prep',
            title: 'Persiapan Pre-Catheterization',
            description: 'Informed consent, puasa 6 jam, hidrasi, cek fungsi ginjal, stop metformin 48h jika eGFR <60',
            required: true,
            category: 'action'
          }
        ]
      ...
      'nstemi-conservative': {
        ...
        type: 'checklist',
        title: 'NSTEMI Low Risk - Selective Invasive Strategy',
        items: [
          {
            id: 'conservative-medical-therapy',
            title: 'Optimalisasi Terapi Medis',
            description: 'Dual antiplatelet (Aspirin + Clopidogrel/Ticagrelor), beta-blocker, statin, ACE-I',
            required: true,
            category: 'medication'
          },
          {
            id: 'conservative-observation',
            title: 'Observasi 48-72 Jam',
            description: 'Monitor nyeri berulang, perubahan EKG, troponin serial, hemodinamik',
            required: true,
            category: 'assessment'
          },
          {
            id: 'conservative-stress-test',
            title: 'Stress Test Sebelum Discharge (Jika Low Risk)',
            description: 'Treadmill exercise test ATAU dobutamine stress echo ATAU myocardial perfusion imaging',
            required: true,
            category: 'assessment'
          },
          {
            id: 'conservative-angiography-if-positive',
            title: 'Angiografi Jika Stress Test Positif ATAU Gejala Berulang',
            description: 'Invasive strategy jika bukti iskemia inducible atau angina rekuren',
            required: false,
            category: 'action'
          },
          {
            id: 'conservative-discharge-planning',
            title: 'Discharge Planning & Secondary Prevention',
            description: 'Edukasi faktor risiko, target LDL <70, kontrol DM/hipertensi, stop merokok, cardiac rehab',
            required: true,
            category: 'documentation'
          }
        ]
  ...
  // DIABETES MELITUS TYPE 2 - PERKENI 2021 + ADA 2024 + WHO 2023
  'diabetes-melitus-tipe-2': {
    diseaseId: 'diabetes-melitus-tipe-2',
    diseaseName: 'Diabetes Melitus Tipe 2',
    startNodeId: 'dm2-initial-assessment',
    nodes: {
      'dm2-initial-assessment': {
        id: 'dm2-initial-assessment',
        type: 'checklist',
        title: 'Initial Assessment & Diagnosis Confirmation',
        description: 'Comprehensive DM screening, diagnosis, dan risk stratification',
        items: [
          {
            id: 'dm2-anamnesis-classic-symptoms',
            title: 'Anamnesis: Gejala Klasik DM (3P + Weight Loss)',
            description: 'Polyuria (sering kencing), Polydipsia (sering haus), Polyphagia (banyak makan tapi berat badan turun). Fatigue, blurred vision, recurrent infections',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-risk-factors',
            title: 'Identifikasi Faktor Risiko DM',
            description: 'Usia >45 tahun, obesitas (BMI >25 Asia), riwayat keluarga DM, hipertensi, dislipidemia, riwayat GDM, PCOS, inaktivitas fisik',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-physical-exam-bmi',
            title: 'Pemeriksaan Fisik: Antropometri',
            description: 'BB, TB, BMI (Asia: overweight ≥23, obese ≥25), lingkar pinggang (laki >90cm, perempuan >80cm = obesitas sentral)',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-blood-pressure',
            title: 'Tekanan Darah',
            description: 'Target DM: <140/90 mmHg (jika young/low ASCVD risk: <130/80). Hipertensi adalah komorbid tersering DM',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-diagnostic-hba1c',
            title: 'HbA1c (Gold Standard Diagnosis & Monitoring)',
            description: 'Diagnosis DM: HbA1c ≥6.5% (2 occasions atau + symptoms). Prediabetes: 5.7-6.4%. Normal: <5.7%. Reflects 3-month average glucose',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-diagnostic-fpg',
            title: 'Fasting Plasma Glucose (FPG)',
            description: 'DM: ≥126 mg/dL (puasa 8 jam). Prediabetes (IFG): 100-125 mg/dL. Normal: <100 mg/dL',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-diagnostic-ogtt',
            title: 'OGTT 2-jam (jika FPG/HbA1c borderline)',
            description: 'Oral Glucose Tolerance Test dengan 75g glucose. DM: 2h ≥200 mg/dL. Prediabetes (IGT): 140-199. Normal: <140',
            required: false,
            category: 'assessment'
          },
          {
            id: 'dm2-random-glucose-if-symptomatic',
            title: 'Random Plasma Glucose (jika Symptomatic)',
            description: 'DM diagnosis: Random glucose ≥200 mg/dL + classic symptoms (3P). Immediate management needed',
            required: false,
            category: 'assessment'
          },
          {
            id: 'dm2-comorbidities-screening',
            title: 'Screening Komorbiditas',
            description: 'Hipertensi, dislipidemia, obesitas, NAFLD, OSA (obstructive sleep apnea pada obese), CVD history',
            required: true,
            category: 'assessment'
          },
          {
            id: 'dm2-medication-history',
            title: 'Riwayat Pengobatan (jika Established DM)',
            description: 'Obat DM saat ini (metformin, sulfonilurea, insulin?), adherence, side effects, durasi terapi',
            required: false,
            category: 'assessment'
          }
        ]
      ...
      'dm2-new-vs-established-decision': {
        id: 'dm2-new-vs-established-decision',
        type: 'decision',
        title: 'New Diagnosis vs Established Diabetes',
        description: 'Tentukan apakah ini diagnosis baru (butuh edukasi & workup komprehensif) atau DM established (fokus control & komplikasi)',
        warningLevel: 'info',
        branches: [
          {
            id: 'new-dm-diagnosis',
            title: 'NEW DIAGNOSIS Diabetes Melitus',
            description: 'Pasien baru terdiagnosis DM → Comprehensive initial workup + diabetes education',
            icon: '🆕',
            color: 'blue',
            nextNodeId: 'dm2-new-diagnosis-workup',
            riskLevel: 'medium'
          },
          {
            id: 'established-dm',
            title: 'ESTABLISHED Diabetes (Follow-up)',
            description: 'Pasien sudah diketahui DM sebelumnya → Assessment glycemic control & complications',
            icon: '📊',
            color: 'teal',
            nextNodeId: 'dm2-glycemic-control-assessment',
            riskLevel: 'low'
          }
        ]
      },

      'dm2-new-diagnosis-workup': {
        id: 'dm2-new-diagnosis-workup',
        type: 'checklist',
        title: 'New DM Diagnosis - Comprehensive Initial Workup',
        description: 'Baseline labs, complications screening, dan structured diabetes education (PERKENI + ADA)',
        items: [
          {
            id: 'new-dm-lipid-profile',
            title: 'Lipid Profile (Fasting)',
            description: 'Total cholesterol, LDL, HDL, TG. Target LDL <100 mg/dL (jika ASCVD <70 mg/dL). Mayoritas DM butuh statin',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-liver-function',
            title: 'Liver Function Test (AST, ALT)',
            description: 'Baseline sebelum mulai metformin/statin. Rule out NAFLD (common di DM). Elevated transaminase → caution dengan statin',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-renal-function',
            title: 'Renal Function: Serum Creatinine & eGFR',
            description: 'Calculate eGFR (CKD-EPI formula). eGFR <60 → adjust metformin dose. eGFR <30 → STOP metformin',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: 'Screening diabetic nephropathy. Albuminuria jika UACR ≥30 mg/g. Start ACEi/ARB jika albuminuria detected',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-retinopathy-screening',
            title: 'Dilated Fundoscopy atau Retinal Photography',
            description: 'Screening diabetic retinopathy. Rujuk ophthalmology dalam 1 tahun diagnosis (DM2) atau immediate jika visual symptoms',
            required: true,
            category: 'assessment'
          },
          {
            ...
            description: '10g monofilament test untuk neuropati perifer. Inspeksi kaki: ulcer, callus, deformitas. Pulses dorsalis pedis/tibialis posterior',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-ecg',
            title: 'Elektrokardiogram (EKG) 12-lead',
            description: 'Baseline cardiac assessment. Rule out silent MI (common di DM). LVH sign (hipertensi kronik)',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-structured-education',
            title: 'Structured Diabetes Self-Management Education (DSME)',
            description: 'Edukasi: patofisiologi DM, target glikemik, diet (carb counting, plate method), exercise, SMBG (self-monitoring blood glucose), hypoglycemia recognition',
            required: true,
            category: 'documentation'
          },
          {
            id: 'new-dm-nutrition-referral',
            title: 'Rujuk Ahli Gizi/Dietitian',
            description: 'Medical nutrition therapy (MNT). Kalori sesuai BB ideal, karbohidrat 45-65% total kalori, fiber ≥25-30g/day, batasi gula sederhana',
            required: true,
            category: 'action'
          },
          {
            id: 'new-dm-lifestyle-modification',
            title: 'Lifestyle Modification Counseling (MANDATORY for ALL)',
            description: 'Target: weight loss 5-10% (jika overweight/obese), exercise 150 min/week moderate intensity, stop smoking, alcohol moderation',
            required: true,
            category: 'action'
          },
          {
            id: 'new-dm-ascvd-risk-calculator',
            title: 'ASCVD Risk Assessment (10-year risk)',
            description: 'Calculate using ASCVD calculator. High risk (≥20%) → aggressive statin + aspirin. Moderate (10-20%) → statin',
            required: true,
            category: 'assessment'
          },
          {
            id: 'new-dm-vaccination',
            title: 'Imunisasi: Influenza Annual + Pneumococcal',
            description: 'Influenza vaccine setiap tahun. Pneumococcal (PPSV23 + PCV13) untuk semua DM ≥2 tahun. Hepatitis B jika <60 tahun',
            required: false,
            category: 'action'
          }
        ]
      ...
      'dm2-glycemic-control-assessment': {
        id: 'dm2-glycemic-control-assessment',
        type: 'checklist',
        title: 'Glycemic Control Assessment & Monitoring',
        description: 'Evaluasi kontrol glikemik dan adherence untuk stratifikasi intensifikasi terapi',
        items: [
          {
            id: 'control-current-hba1c',
            title: 'HbA1c Saat Ini (dalam 3 bulan terakhir)',
            description: 'Target umum: <7%. Individualized: young/healthy <6.5%, elderly/comorbid <8%. Check q3 bulan jika tidak terkontrol, q6 bulan jika stable',
            required: true,
            category: 'assessment'
          },
          {
            id: 'control-fasting-glucose',
            title: 'Fasting Plasma Glucose (FPG)',
            description: 'Target: 80-130 mg/dL. Jika FPG terkontrol tapi HbA1c tinggi → postprandial glucose bermasalah',
            required: true,
            category: 'assessment'
          },
          {
            id: 'control-postprandial-glucose',
            title: 'Postprandial Glucose (2h after meal)',
            description: 'Target: <180 mg/dL. Elevated PPG → consider acarbose, short-acting insulin, GLP-1 agonist',
            required: false,
            category: 'assessment'
          },
          {
            id: 'control-smbg-pattern',
            title: 'Review Self-Monitoring Blood Glucose (SMBG) Pattern',
            description: 'Logbook glucose: fasting, pre-meal, 2h post-meal, bedtime. Identifikasi pattern (dawn phenomenon, nocturnal hypo)',
            required: false,
            category: 'assessment'
          },
          {
            id: 'control-hypoglycemia-history',
            title: 'Riwayat Hipoglikemia (Terutama jika pakai Insulin/SU)',
            description: 'Frequency, severity, awareness. Severe hypoglycemia (butuh bantuan orang lain) → relax target HbA1c. Hypoglycemia unawareness → bahaya!',
            required: true,
            category: 'safety'
          },
          {
            id: 'control-medication-adherence',
            title: 'Adherence Terapi & Barriers',
            description: 'Apakah minum obat teratur? Side effects (GI upset metformin, hypoglycemia SU)? Cost issues? Pill burden?',
            required: true,
            category: 'assessment'
          },
          {
            id: 'control-lifestyle-adherence',
            title: 'Adherence Lifestyle Modification',
            description: 'Diet compliance, exercise frequency, weight change. Lifestyle adalah CORNERSTONE terapi DM',
            required: true,
            category: 'assessment'
          },
          {
            id: 'control-weight-change',
            title: 'Perubahan Berat Badan',
            description: 'Weight gain (insulin, SU, TZD) vs weight loss (SGLT2i, GLP-1). Unintentional weight loss → rule out uncontrolled DM atau malignancy',
            required: true,
            category: 'assessment'
          }
        ]
      ...
      'dm2-control-stratification-decision': {
        id: 'dm2-control-stratification-decision',
        type: 'decision',
        title: 'Glycemic Control Stratification (HbA1c-based)',
        description: 'Tentukan intensitas intervensi berdasarkan kontrol glikemik saat ini (ADA 2024)',
        warningLevel: 'warning',
        branches: [
          {
            id: 'well-controlled',
            title: 'WELL CONTROLLED (HbA1c <7% at Target)',
            description: 'Maintain current therapy + continue lifestyle + annual complications screening',
            icon: '✅',
            color: 'green',
            nextNodeId: 'dm2-maintenance-protocol',
            riskLevel: 'low'
          },
          {
            id: 'poorly-controlled',
            title: 'POORLY CONTROLLED (HbA1c 7-9%)',
            description: 'Intensify therapy: add 2nd/3rd agent, optimize lifestyle, address barriers',
            icon: '⚠️',
            color: 'orange',
            nextNodeId: 'dm2-intensify-therapy',
            riskLevel: 'medium'
          },
          {
            id: 'very-poor-control',
            title: 'VERY POOR CONTROL (HbA1c >9% atau Symptomatic)',
            description: 'Aggressive intervention: consider insulin initiation, address acute complications',
            icon: '🚨',
            color: 'red',
            nextNodeId: 'dm2-aggressive-intervention',
            riskLevel: 'high'
          }
        ]
      },

      'dm2-maintenance-protocol': {
        id: 'dm2-maintenance-protocol',
        type: 'checklist',
        title: 'Maintenance Protocol - Well Controlled DM',
        description: 'Continue effective therapy + intensify complications screening & cardiovascular risk reduction',
        items: [
          {
            id: 'maintenance-continue-current',
            title: 'Continue Current Effective Regimen',
            description: 'Jangan ubah terapi yang sudah berhasil. Reinforce adherence. Review medication list',
            required: true,
            category: 'medication'
          },
          {
            id: 'maintenance-lifestyle-reinforce',
            title: 'Reinforce Lifestyle Modification',
            description: 'Diet, exercise, weight management tetap PENTING meski HbA1c terkontrol. Prevent long-term complications',
            required: true,
            category: 'action'
          },
          {
            id: 'maintenance-annual-hba1c',
            title: 'HbA1c Monitoring q6 bulan (jika stable)',
            description: 'Frequency: q3 bulan jika ada perubahan terapi, q6 bulan jika stable at target',
            required: true,
            category: 'documentation'
          },
          {
            id: 'maintenance-annual-lipid',
            title: 'Annual Lipid Profile',
            description: 'Yearly lipid panel. Adjust statin jika LDL tidak at goal (<100, atau <70 jika ASCVD)',
            required: true,
            category: 'assessment'
          },
          {
            id: 'maintenance-annual-uacr',
            title: 'Annual UACR & eGFR',
            description: 'Screening diabetic nephropathy. Jika albuminuria develop → start ACEi/ARB',
            required: true,
            category: 'assessment'
          },
          {
            id: 'maintenance-annual-retinal',
            title: 'Annual Retinal Screening (jika previous normal)',
            description: 'Fundoscopy atau retinal photo. Jika 2 consecutive normal screening → bisa extend ke q2 tahun',
            required: true,
            category: 'assessment'
          },
          {
            id: 'maintenance-annual-foot',
            title: 'Annual Comprehensive Foot Exam',
            description: 'Monofilament test, pulses, skin integrity. Education perawatan kaki. High risk → rujuk podiatry',
            required: true,
            category: 'assessment'
          },
          {
            id: 'maintenance-statin-intensify',
            title: 'Statin Therapy (ASCVD Risk Reduction)',
            description: 'Semua DM 40-75 tahun → moderate-intensity statin. High ASCVD risk atau established CVD → high-intensity statin',
            required: true,
            category: 'medication'
          },
          {
            id: 'maintenance-acei-arb',
            title: 'ACEi/ARB (jika Hypertension atau Albuminuria)',
            description: 'Nephroprotective + cardioprotective. Lisinopril 10-40mg/day atau Losartan 50-100mg/day. Monitor K+ dan creatinine',
            required: false,
            category: 'medication'
          },
          {
            id: 'maintenance-aspirin',
            title: 'Aspirin 100mg/day (jika ASCVD risk ≥10% dan no bleeding risk)',
            description: 'Primary prevention controversial (ASCEND trial). Secondary prevention (post-MI/stroke) → MANDATORY',
            required: false,
            category: 'medication'
          }
        ]
      ...
      'dm2-intensify-therapy': {
        id: 'dm2-intensify-therapy',
        type: 'checklist',
        title: 'Intensify Therapy - Poorly Controlled DM (HbA1c 7-9%)',
        description: 'Stepwise addition of agents, address barriers, optimize lifestyle',
        items: [
          {
            id: 'intensify-assess-barriers',
            title: 'Identify & Address Barriers to Control',
            description: 'Non-adherence (cost, side effects, complexity), inadequate diet/exercise, stress/depression, inadequate medication doses',
            required: true,
            category: 'assessment'
          },
          {
            id: 'intensify-lifestyle-reinforce',
            title: 'RE-INTENSIFY Lifestyle Modification',
            description: 'Rujuk ulang dietitian, exercise prescription, weight loss program jika obese. Lifestyle first before adding pills!',
            required: true,
            category: 'action'
          },
          {
            id: 'intensify-metformin-optimize',
            title: 'Optimize Metformin Dose (jika belum max)',
            description: 'Titrate metformin hingga 2000-2550mg/day (divided doses). Up-titrate slowly untuk minimize GI side effects',
            required: true,
            category: 'medication'
          },
          {
            id: 'intensify-add-second-agent-decision',
            title: 'ADD 2nd AGENT - Pilih berdasarkan Patient Profile',
            description: 'SGLT2i (jika CKD/HF), GLP-1 RA (jika obese/ASCVD), DPP-4i (neutral), SU (cheap tapi hypoglycemia risk), TZD (avoid jika HF)',
            required: true,
            category: 'medication'
          },
          {
            id: 'intensify-sglt2i-if-ckd-hf',
            title: 'SGLT2 Inhibitor (PREFERRED jika eGFR >20 atau HF)',
            description: 'Empagliflozin 10-25mg, Dapagliflozin 10mg. Benefit: ↓CV death, ↓HF hospitalization, ↓CKD progression. SE: UTI, genital candidiasis, DKA risk (rare)',
            required: false,
            category: 'medication'
          },
          {
            id: 'intensify-glp1-if-ascvd-obese',
            title: 'GLP-1 Receptor Agonist (PREFERRED jika ASCVD atau Obesity)',
            description: 'Semaglutide 0.5-1mg SC weekly, Dulaglutide 1.5mg SC weekly. Benefit: ↓weight, ↓CV events. SE: nausea, pancreatitis risk',
            required: false,
            category: 'medication'
          },
          {
            id: 'intensify-dpp4i-neutral',
            title: 'DPP-4 Inhibitor (Weight Neutral, Safe)',
            description: 'Sitagliptin 100mg/day, Linagliptin 5mg/day. Benefit: safe di CKD, no hypoglycemia. Less potent than SGLT2i/GLP-1',
            required: false,
            category: 'medication'
          },
          {
            id: 'intensify-sulfonylurea-cheap',
            title: 'Sulfonylurea (Cost-effective, tapi Hypoglycemia Risk)',
            description: 'Glimepiride 1-4mg/day, Gliclazide MR 30-120mg. CHEAP tapi risk hypoglycemia + weight gain. Avoid jika elderly/CKD',
            required: false,
            category: 'medication'
          },
          {
            id: 'intensify-recheck-3month',
            title: 'Re-assess HbA1c dalam 3 Bulan',
            description: 'Jika HbA1c masih >7% setelah 3 bulan → consider triple therapy atau insulin',
            required: true,
            category: 'documentation'
          }
        ]
      ...
      'dm2-aggressive-intervention': {
        id: 'dm2-aggressive-intervention',
        type: 'checklist',
        title: 'Aggressive Intervention - Very Poor Control (HbA1c >9%)',
        description: 'Consider insulin initiation, rule out acute complications, address severe hyperglycemia',
        items: [
          {
            id: 'aggressive-symptomatic-check',
            title: 'Rule Out Acute Hyperglycemic Emergencies',
            description: 'DKA (anion gap acidosis, ketones) atau HHS (extreme hyperglycemia >600, hyperosmolar). Jika ada → immediate hospitalization!',
            required: true,
            category: 'safety'
          },
          {
            id: 'aggressive-glucose-toxicity',
            title: 'Assess Glucotoxicity (Chronic Hyperglycemia)',
            description: 'HbA1c >9% → beta-cell dysfunction dari glucotoxicity. Butuh insulin sementara untuk "rest" beta-cells',
            required: true,
            category: 'assessment'
          },
          {
            id: 'aggressive-weight-loss-check',
            title: 'Unintentional Weight Loss?',
            description: 'Significant weight loss despite high glucose → severe insulin deficiency. Mungkin LADA (latent autoimmune diabetes of adults) → check GAD antibody',
            required: true,
            category: 'assessment'
          },
          {
            id: 'aggressive-basal-insulin-initiation',
            title: 'Initiate BASAL INSULIN (jika HbA1c >10% atau symptomatic)',
            description: 'Insulin glargine/detemir 10 unit SC qHS atau 0.1-0.2 unit/kg. Titrate 2 unit q3 days based on FPG. Target FPG 80-130 mg/dL',
            required: false,
            category: 'medication'
          },
          {
            id: 'aggressive-continue-metformin',
            title: 'CONTINUE Metformin (jika no contraindication)',
            description: 'Tetap lanjutkan metformin meski mulai insulin. Metformin ↓insulin resistance, prevent weight gain',
            required: true,
            category: 'medication'
          },
          {
            id: 'aggressive-add-glp1-if-obese',
            title: 'Consider GLP-1 RA + Basal Insulin (jika Obese)',
            description: 'Combination GLP-1 + insulin → better glucose control, less weight gain, less insulin dose needed. Semaglutide + insulin glargine',
            required: false,
            category: 'medication'
          },
          {
            id: 'aggressive-stop-sulfonylurea',
            title: 'STOP Sulfonylurea jika Start Insulin',
            description: 'SU + insulin → high hypoglycemia risk. Discontinue SU when initiating insulin',
            required: false,
            category: 'medication'
          },
          {
            id: 'aggressive-smbg-education',
            title: 'Intensive SMBG Education (jika pakai Insulin)',
            description: 'Fasting glucose monitoring MANDATORY. Adjust insulin dose based on FPG pattern. Recognize hypoglycemia symptoms',
            required: true,
            category: 'action'
          },
          {
            id: 'aggressive-hypoglycemia-education',
            title: 'Hypoglycemia Awareness & Emergency Plan',
            description: 'Rule of 15: 15g fast-acting carbs (3 glucose tablets, 4oz juice) → recheck in 15 min. Severe hypo → glucagon kit education untuk keluarga',
            required: true,
            category: 'safety'
          },
          {
            id: 'aggressive-recheck-1month',
            title: 'Re-assess dalam 1-2 Minggu (Insulin Titration)',
            description: 'Frequent follow-up untuk titrate insulin. HbA1c recheck dalam 1 bulan. Jika controlled → consider step-down ke oral agents',
            required: true,
            category: 'documentation'
          },
          {
            id: 'aggressive-endocrine-referral',
            title: 'Rujuk Endokrinologist (jika HbA1c >10% atau Refractory)',
            description: 'Complex cases, multiple insulin regimens, refractory hyperglycemia → specialist care',
            required: false,
            category: 'action'
          }
        ]
      ...
      'dm2-complications-screening': {
        id: 'dm2-complications-screening',
        type: 'checklist',
        title: 'Comprehensive Diabetes Complications Screening',
        description: 'Annual atau periodic screening untuk microvascular & macrovascular complications (PERKENI + ADA)',
        items: [
          {
            id: 'comp-diabetic-retinopathy',
            title: 'RETINOPATHY: Dilated Fundoscopy atau Retinal Photo',
            description: 'Annual screening. Jika proliferative DR atau macular edema → immediate ophthalmology referral untuk laser/anti-VEGF',
            required: true,
            category: 'assessment'
          },
          {
            id: 'comp-diabetic-nephropathy',
            title: 'NEPHROPATHY: UACR + eGFR',
            description: 'Annual UACR (albuminuria ≥30 mg/g). eGFR untuk stage CKD. Albuminuria → start ACEi/ARB + SGLT2i',
            required: true,
            category: 'assessment'
          },
          {
            id: 'comp-peripheral-neuropathy',
            title: 'NEUROPATHY: 10g Monofilament Test + Ankle Reflex',
            description: 'Annual screening. Loss of protective sensation → high risk diabetic foot ulcer. Gabapentin/pregabalin jika painful neuropathy',
            required: true,
            category: 'assessment'
          },
          {
            id: 'comp-autonomic-neuropathy',
            title: 'Autonomic Neuropathy Screening (jika lama DM)',
            description: 'Resting tachycardia, orthostatic hypotension, gastroparesis (bloating, early satiety), erectile dysfunction, bladder dysfunction',
            required: false,
            category: 'assessment'
          },
          {
            id: 'comp-diabetic-foot-exam',
            title: 'DIABETIC FOOT: Comprehensive Examination',
            description: 'Inspeksi kulit (ulcer, callus, fissure), deformitas (Charcot), pulses (PAD), infection signs. High risk → podiatry referral',
            required: true,
            category: 'assessment'
          },
          {
            id: 'comp-cvd-assessment',
            title: 'CARDIOVASCULAR: ECG + Lipid + BP',
            description: 'Annual ECG (silent MI common di DM). Lipid profile. BP control <140/90. Consider cardiac stress test jika typical/atypical chest pain',
            required: true,
            category: 'assessment'
          },
          {
            id: 'comp-peripheral-arterial-disease',
            title: 'Peripheral Arterial Disease (PAD) Screening',
            description: 'Ankle-Brachial Index (ABI) jika usia >50 atau symptoms (claudication). ABI <0.9 = PAD → aspirin + statin + risk factor modification',
            required: false,
            category: 'assessment'
          },
          {
            id: 'comp-depression-screening',
            title: 'Depression & Diabetes Distress Screening',
            description: 'PHQ-2/PHQ-9 untuk depression. Diabetes distress common (burnout dari self-management). Rujuk psikologi/psikiatri jika positif',
            required: false,
            category: 'assessment'
          },
          {
            id: 'comp-nafld-screening',
            title: 'NAFLD Screening (jika Elevated Transaminase)',
            description: 'Non-alcoholic fatty liver disease sangat common di DM + obesity. FibroScan atau liver ultrasound. Weight loss adalah terapi utama',
            required: false,
            category: 'assessment'
          }
        ]
      ...
      'ra-disease-activity-assessment': {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'DAS28 = 0.56���TJC28 + 0.28√SJC28 + 0.70ln(ESR) + 0.014(PGA). Remission <2.6, Low 2.6-3.2, Moderate 3.2-5.1, High >5.1. Target: Remission or Low Disease Activity',
            required: true,
            category: 'assessment'
          },
          {
